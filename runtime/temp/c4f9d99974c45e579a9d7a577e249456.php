<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\wamp64\www\webmain\public/../application/index\view\product\child.html";i:1567414889;s:63:"D:\wamp64\www\webmain\application\index\view\public\common.html";i:1567417419;}*/ ?>
<html lang="zh">
            ...
            <div class="hero__headline-wrapper  contentmask__paddingcontainer">
              <div class="hero__headline">
                <h1 class="text-center headline--xl">
                  迈特的洗碗机、履带式洗碗机、篮筐机、揭盖机、餐具洗涤配套产品
                </h1>
              </div>
      ...
      <div class="menu__container menu__container--list menu__container--list-tiles">
        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
          <div class="menubox__wrapper">
            <a class="menubox  menubox--with-indicator " href="<?php echo $data['linkto']; ?>">
              <div class="menubox__image"><img class="load__on__scroll load__on__scroll--loaded" src="<?php echo $data['path']; ?>" data-src="<?php echo $data['path']; ?>"
                  width="600" height="600" alt=""></div>
              
              <div class="menubox__contentwrapper">
                <div class="menubox__textwrapper">
                  <div class="menubox__headline headline--h4"><?php echo $data['name']; ?></div>
                  <div class="menubox__content"><?php echo $data['doc']; ?>
                  </div><span class="link menubox__fakelink"> 显示产品 </span>
                </div>
              </div>
            </a>
          </div>
