<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\wamp64\www\webmain\public/../application/index\view\product\detail.html";i:1567478169;s:63:"D:\wamp64\www\webmain\application\index\view\public\common.html";i:1567497514;}*/ ?>
<html lang="zh">
...
<main class="main">
  ...
  <div id="c25632" class="frame frame-default frame-type-avMATE ELECTRICAL_pagehero frame-layout-indent_small  ">
  ...
  <div class="container" style="margin-bottom: 60px;">
    <p class="detail-cp-box">
      <img src="<?php echo $detail['path']; ?>" alt="<?php echo $detail['name']; ?>">
    </p>
    <?php if(!(empty($detail['xnpath']) || (($detail['xnpath'] instanceof \think\Collection || $detail['xnpath'] instanceof \think\Paginator ) && $detail['xnpath']->isEmpty()))): ?>
    <p class="detail-cp-box">
      <img src="<?php echo $detail['xnpath']; ?>" alt="<?php echo $detail['name']; ?>-性能参数">
    </p>
    <?php endif; if(empty($detail['xnpath']) || (($detail['xnpath'] instanceof \think\Collection || $detail['xnpath'] instanceof \think\Paginator ) && $detail['xnpath']->isEmpty())): if(is_array($detail['imgspath']) || $detail['imgspath'] instanceof \think\Collection || $detail['imgspath'] instanceof \think\Paginator): $k = 0; $__LIST__ = $detail['imgspath'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($k % 2 );++$k;?>
        <p class="detail-cp-box">
          <img src="<?php echo $data; ?>" alt="<?php echo $detail['name']; ?>-介绍<?php echo $k; ?>">
        </p>
