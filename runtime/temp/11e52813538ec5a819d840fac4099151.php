<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\wamp64\www\webmain\public/../application/index\view\case_studies\index.html";i:1566897247;s:63:"D:\wamp64\www\webmain\application\index\view\public\common.html";i:1566899560;}*/ ?>
<html lang="zh">
                  ...
                  <div class="col-xs-12">
                    <div class="hero__subheader">
                      <h2 class="text-center headline--h2">
                        我们为何如此重视您的需求——我们又如何满足您的需求
                      </h2>
                    </div>
                  </div>
                </div>
              </div>
            </div><img class="hero__image img-responsive" src="/assets/original/images/herowelle-wasser.jpg" width="1440" height="200" alt=""></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <div id="c33651" class="frame frame-default frame-type-avMATE ELECTRCAL_reference_overview frame-layout-0 frame-space-after-medium initialized">
      ...
      <div class="reference__list">
        <form id="filterform-33651" action="https://www.MATE ELECTRCALchina.com/zh/case-studies/?tx_avMATE ELECTRCAL_reference_overview%5Baction%5D=filter&amp;cHash=5ef64dcfae2c9c8b149d282505f8b5c3" method="post">
            ...
            <div class="col-xs-12 col-sm-4 col-md-2 col-md-offset-3 col-filter">
              <div class="filter" data-filter="">
                ...
                <div class="filter__content">
                  ...
                  <div class="filter__buttonwrapper"><i class="btn btn--sm btn--primary waves-input-wrapper waves-effect waves-darkblue"><span class="waves-textwrapper"><input class="waves-button-input" type="submit" value="接受"></span></i></div>
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-2 col-filter">
              <div class="filter" data-filter="">
          ...
          <div class="filterdisablers" data-filterdisablers=""></div>
        </form>
        <script>
          jQuery(function() {
            var cUid = 33651;
            ...
            jQuery('#filterform-' + cUid).filterloader({
              contentSelector: contentSelector,
              stateSource: stateSource,
              lockFiltersSelector: '.filterdisablers .filterdisablers__disabler'
            });
          });
        </script>
        <div id="filtercontent-33651">
          <div data-articleloader="" class="pagination" id="pagination-33651">
                  ...
                  <div class="menubox__contentwrapper">
                    <div class="menubox__contentwrapper">
                      <div class="menubox__textwrapper">
                        <div class="menubox__tagline"><span class="left">
              ...
              <div class="menubox__wrapper menubox__wrapper--tiles-vertical masonry--layouted" style="position: absolute; left: 66.59%; top: 0px;">
                ...
                案例……
                        ...
                        <div class="menubox__headline headline--h4">
                          ...
                          圣玛丽医院 (Marienhospital Stuttgart)，斯图加特
          ...
          详见案例资料（实例说明）
              ...
              <div class="menubox__wrapper menubox__wrapper--tiles-vertical masonry--layouted" style="position: absolute; left: 0%; top: 548px;">
                ...
                案例……
                        ...
                        <div class="menubox__content">
                          伦敦希斯罗万豪酒店：相比之前的解决方案简直是天壤之别。新洗碗机高效得多。
          ...
          详见案例资料（实例说明）
              ...
              <div class="menubox__wrapper menubox__wrapper--tiles-vertical masonry--layouted" style="position: absolute; left: 66.59%; top: 610px;">
                ...
                案例……
                        ...
                        <div class="menubox__content">
                          巴黎综合理工大学安装了 M-iQ 和 WasteStar 系统来优化洗碗过程以及有机垃圾的收集和回收利用。
          ...
          详见案例资料（实例说明）
              ...
              <div class="menubox__wrapper menubox__wrapper--tiles-vertical masonry--layouted" style="position: absolute; left: 33.25%; top: 1105px;">
                ...
                案例……
                        ...
                        <div class="menubox__content">
                          对 M-iQ 长龙式洗碗机的最初投资在三年内获得了回报，这些完全得益于其效率、技术、易用性及可靠性。
              ...
              <div class="menubox__wrapper menubox__wrapper--tiles-vertical masonry--layouted" style="position: absolute; left: 66.59%; top: 1159px;">
                ...
                案例……
                        ...
                        <div class="menubox__headline headline--h4">
                          ...
                          Black Forest Distillers GmbH, Stuttgart
          ...
          <script>
            jQuery(function() {
              var cUid = 33651,
                $masonryContainer = jQuery('#c' + cUid + ' .menu__container--tiles');

              $masonryContainer.removeClass('menu__container--tiles--equalheight');

              $masonryContainer.masonryMenu();
              jQuery('#c' + cUid + ' [data-articleloader]').articleloader({
                prev: {
                  onAfter: function($loader, $trigger, triggerConfig, $newContent) {
                    jQuery.fn.articleloader.defaults.prev.onAfter($loader, $trigger, triggerConfig, $newContent);

                    $masonryContainer.prependedToMasonryMenu($masonryContainer.find('.menubox__wrapper').not('.masonry--layouted'));
                    $masonryContainer.layoutMasonryMenu();
                    $masonryContainer.find('.load__on__scroll').trigger('loaded.load_on_scroll');
                  }
                },
                next: {
                  onAfter: function($loader, $trigger, triggerConfig, $newContent) {
                    jQuery.fn.articleloader.defaults.next.onAfter($loader, $trigger, triggerConfig, $newContent);

                    $masonryContainer.appendedToMasonryMenu($masonryContainer.find('.menubox__wrapper').not('.masonry--layouted'));
                    $masonryContainer.layoutMasonryMenu();
                    $masonryContainer.find('.load__on__scroll').trigger('loaded.load_on_scroll');
                  }
                }
